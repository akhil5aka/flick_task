    ...
    try {
      ...
      for (const textFile of textFiles) {
        ...
        try {
          ...
          const uuid = response.data.data.submissionResponse.acceptedDocuments[0].uuid;

            var submissionUid=response.data.data.submissionResponse.submissionUid;
          const invoice_number = response.data.data.submissionResponse.acceptedDocuments[0]
              .invoiceCodeNumber;
